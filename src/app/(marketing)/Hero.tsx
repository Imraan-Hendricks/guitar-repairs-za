    ...
    <section>
      <div className='relative'>
        <Image
          ...
          alt='guitar-and-amp'
        />
        <div className='relative h-screen bg-gradient-to-bl from-black/75 via-black/80 to-black sm:bg-gradient-to-bl sm:from-black/10 sm:via-black/80 sm:to-black'>
          <div className='grid gap-8 content-center h-full container mx-auto px-5'>
            <Image
              className='h-40 sm:h-48 opacity-25 w-auto mx-auto sm:mx-0'
              src={LogoSymbol}
              alt='logo-symbol'
            />
            <div className='grid gap-2'>
              <p className='text-sm sm:text-base text-white text-yellow-300/60 text-center sm:text-start'>
                - by Joshua Houston
              </p>
              <h1 className='text-5xl sm:text-6xl font-bold text-white text-center sm:text-start'>
                Guitar <span className='text-yellow-300/90'>Repair</span> ZA
              </h1>
            </div>
            <hr className='border-white/10 max-w-2xl' />
            <p className='text-lg sm:text-xl font-normal tracking-wide text-white/50 max-w-2xl text-center sm:text-start'>{`Unlock Your Guitar's True Sound: Precision Repairs that Won't Break the Bank!`}</p>
